...
export default function Cta() {
  return (
    <div className="relative isolate px-6 py-32 lg:px-8">
      ...
      >
        <div
          className="aspect-[1108/632] w-[69.25rem] flex-none bg-gradient-to-r from-[#fbcfe8] to-[#f472b6] opacity-30"
          style={{
            clipPath:
      ...
      <div className="mx-auto max-w-2xl text-center" data-aos="fade-up" data-aos-anchor-placement="center-bottom">
        <h2 className="text-3xl font-semibold text-gray-100 sm:text-4xl">
          Enjoy a free consultation and custom tattoo service
        </h2>
        <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-pink-200">
          Ready to make your tattoo dreams a reality?
        </p>
