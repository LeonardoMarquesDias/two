...
export default function Button() {
  ...
  return (
    <div className="">
      <button
        type="button"
        className="rounded-md bg-button-200 px-3.5 py-2.5 text-sm font-semibold text-gray-100 shadow-sm hover:bg-button-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold-200"
        onClick={openModal}
      >
        BOOK NOW
      </button>
      ...
      <Transition appear show={isOpen} as={Fragment}>
        <Dialog as="div" className="relative z-20" onClose={closeModal}>
          <Transition.Child
            ...
            leaveTo="opacity-0"
          >
            <div className="fixed inset-0 bg-pink-200 bg-opacity-80 transition-opacity" />
          </Transition.Child>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0">
              ...
              >
                <Dialog.Panel className="relative w-full transform overflow-hidden rounded-lg bg-gray-800 px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:max-w-sm sm:p-6">
                  <div className="mt-3 text-center sm:mt-5">
                    ...
                    <ul role="list" className="grid grid-cols-1 gap-6 sm:grid-cols-1 mt-4">
                      {people.map((person, index) => (
                        <li
                          key={index}
                          className="col-span-1 flex flex-col divide-y divide-gray-950 rounded-lg bg-gray-700 text-center shadow"
                        >
                          <div className="flex flex-1 flex-col p-6">
                            <img className="mx-auto border-2 border-pink-500 bg-cover h-32 w-32 flex-shrink-0 rounded-full" src={person.imageUrl} alt="" />
                            <h3 className="mt-4 text-sm font-bold text-pink-500">{person.name}</h3>
                          ...
                          <div>
                            <div className="flex divide-x divide-gray-950">
                              ...
                              <div className="flex w-0 flex-1 bg-pink-500">
                                <Link
                    ...
                    <div className="mt-5 sm:mt-6">
                      <button
                        type="button"
                        className="inline-flex w-full justify-center rounded-md bg-gray-800 px-3 py-2 text-sm font-semibold text-gray-100 shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2"
                        onClick={closeModal}
                      >
                        Close
                      </button>
