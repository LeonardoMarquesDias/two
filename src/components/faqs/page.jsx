...
export default function Faqs() {
  return (
    <div className="mt-20 sm:mt-40" id="faqs">
                    ...
                    <dt>
                      <DisclosureButton className="flex w-full items-start justify-between text-left text-gray-400">
                        ...
                        <span className="ml-6 flex h-7 items-center">
                          {open ? (
                            <MinusSmallIcon className="h-6 w-6 text-pink-200" aria-hidden="true" />
                          ) : (
                            <PlusSmallIcon className="h-6 w-6 text-pink-200" aria-hidden="true" />
                          )}
                        </span>
                      </DisclosureButton>
                    </dt>
                    <DisclosurePanel as="dd" className="mt-2 pr-12">
                      <p className="text-base text-justify leading-7 text-gray-100 whitespace-pre-line">{faq.answer}</p>
                    </DisclosurePanel>
                  </>
                )}
              </Disclosure>
